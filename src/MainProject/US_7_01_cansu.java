...
public class US_7_01_cansu extends BaseDriver {
    //    PC_07
...
//    AC_07
//    Kullanıcı, hesabına giriş yaptığı zaman, kendi hesabını sistemden silebilmelidir.
//    Hesap silme işlemi sırasında doğru şifre girildiğinde, hesap başarılı bir şekilde silinebilmelidir.
    @Test
    public void Test(){
        ...
        WebElement hesabimBUTON=driver.findElement(By.xpath("//a[text()='Hesabım']"));
        hesabimBUTON.click();
        MyFunc.Wait(3);
        ...
        WebElement hesapSilSifre=driver.findElement(By.xpath("//input[@type='password']"));
        hesapSilSifre.sendKeys("123456Aa");
        MyFunc.Wait(3);
        ...
        WebElement ekran=driver.findElement(By.xpath("//a[text()='Hesap aç']"));
        MyFunc.Wait(2);


        Assert.assertTrue("hata",ekran.getText().contains("Hesap aç"));
